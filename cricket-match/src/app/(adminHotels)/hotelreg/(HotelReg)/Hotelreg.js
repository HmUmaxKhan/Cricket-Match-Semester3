...
import { useDispatch, useSelector } from "react-redux";
    ...
    function Hotelreg() {
      ...
      <input type="text" className="form-control" id="floatingInput"  name="Name" onChange={Change} />
      <label htmlFor="floatingInput">Name of Hotel</label>
    </div>
    <br></br>
    
        <div className="form-floating mb-3 ">
      <input type="text" className="form-control" id="floatingInput"  name="City" onChange={Change} />
    ...
    <br></br>
        ...
        <div className="form-floating mb-3 ">
      <input type="text" className="form-control" id="floatingInput" name="Address" onChange={Change} />
      <label htmlFor="floatingInput">Address</label>
    </div>
    <br></br>
    
    <div className="form-floating">
      <input type="number" className="form-control" id="floatingPassword"  name="PhoneNumber" onChange={Change}/>
    ...
    <div className="form-floating mb-3 ">
      <input type="text" className="form-control" id="floatingInput" placeholder="name@example.com" name="Description" onChange={Change} />
      <label htmlFor="floatingInput">Description</label>
    </div>
    <br></br>
    
    <div className="form-floating mb-3 ">
      <input type="text" className="form-control" id="floatingInput" placeholder="name@example.com" name="RoomCapacity" onChange={Change} />
      <label htmlFor="floatingInput">No. of Rooms</label>
    </div>
    <br></br>
    
    <div className="form-floating mb-3 ">
      <input type="Number" className="form-control" id="floatingInput" placeholder="name@example.com" name="RoomPrice" onChange={Change} />
      <label htmlFor="floatingInput">Price </label>
    </div>
    <br></br>

    <div className="form-floating mb-3 ">
      <input type="text" className="form-control" id="floatingInput" placeholder="name@example.com" name="WebUrl" onChange={Change} />
