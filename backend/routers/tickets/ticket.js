...
router.post("/tickets",AuthToken,
 async(req,res)=> {
  ...
  const user = await querySql({
    query: "INSERT INTO Booked_Tickets (TicketNumber,match_id,user_id,Category,price,seat_number) VALUES(?,?,?,?,?,?)",
    values: [seat_number,match_id,user_id,Category,price,seat_number]
  })
